...
<div class="profile-page-bg" style="background-image: url('https://images.unsplash.com/photo-1504674900247-0877df9cc836?q=80&w=2070&auto=format&fit=crop');">
        ...
        <div class="profile-header">
            ...
            <div class="profile-info-section">
                ...
                <div class="profile-name-row">
                    ...
                    @if(Auth::id() !== $user->user_id) <form action="#" method="POST">
                            @csrf
                            @if($isFollowing)
                        ...
                        <div class="recipe-card">
                            ...
                            <div class="recipe-card-info">
                                ...
                                <div class="card-stats">
                                    ...
                                    <span>❤️ {{ $recipe->likes_count ?? 0 }}</span> </div>
                            </div>
                        </div>
                    </a>
                    @endforeach
...
<style>
    ...
    .profile-page-bg {
        ...
        background-attachment: fixed; /* ภาพนิ่งเวลาเลื่อน */
    }

    /* 2. Main Overlay (Glass Effect) */
    .profile-overlay-container {
        background: rgba(0, 0, 0, 0.75); /* สีดำโปร่งแสง 75% */
        backdrop-filter: blur(5px); /* เบลอฉากหลังเล็กน้อย */
        min-height: 100vh;
        width: 100%;
        padding: 100px 10% 50px 10%; /* เว้นขอบซ้ายขวา 10% */
    ...
    .btn-follow {
        background-color: #3b8ac4; /* สีฟ้า */
        color: white;
        border: none;
        padding: 8px 25px;
        border-radius: 20px; /* ขอบมนเป็นแคปซูล */
        font-size: 14px;
        font-weight: bold;
        cursor: pointer;
        transition: 0.3s;
    ...
    .btn-follow.following {
        background-color: #555; /* ถ้าติดตามแล้วให้ปุ่มเป็นสีเทา */
        box-shadow: none;
    }
    ...
    .tab-item {
        ...
        color: white;
        padding-bottom: 10px;
        border-bottom: 2px solid white; /* ขีดเส้นใต้ Active */
        cursor: pointer;
    }
    ...
    .recipe-grid {
        display: grid;
        grid-template-columns: repeat(auto-fill, minmax(220px, 1fr)); /* Grid อัตโนมัติ */
        gap: 20px;
    }
