...
<body>
            ...
            <div class="signUp-box" div data-aos="fade-up">
                ...
                <div class="username-box">
                    ...
                    @error('email')
                     <div style="color: #fa6565; font-size: 0.9em; margin-top: 5px;">{{ $message }}</div>
                        @enderror
                ...
                <div class="password-box">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation"  class="input-signUp" placeholder="confirm password">
                </div>
                <!-- BUTTON -->
