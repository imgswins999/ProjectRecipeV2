        ...
        <div class="first-insert">
            ...
            <div class="name-type-region-des-container">
                ...
                <div class="name-container">
                    <input type="text" value="{{$recipe->title}}" class="writing-name-input">
                </div>
                ...
                <div class="type-region-container">
                    ...
                    <div class="type-container">
                        <select name="category_id" id="category_id" class="type-input">
                            <option value="{{$recipe->category_id}}"  selected>{{$recipe->category->category_name}}</option>
                    ...
                    <div class="region-container">
                        <select name="region_id" id="region_id" class="type-input">
                            <option value="{{$recipe->region_id}}" selected>{{$recipe->region->region_name}}</option>
...
<div id="list-container" class="list-box">
    ...
    @endforeach
        ...
        <div class="procedure-container">
            <textarea class="procedure-input">{{$recipe->instructions}}</textarea>
        </div>
